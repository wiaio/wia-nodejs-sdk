...
//         else cb(new WiaExceptions.HTTPBadRequestError(response.statusCode, body || ''));
//       }
//     });
//   },
...
//       if (cb) {
//         if (error) return cb(error, null);
//         if (response.statusCode == 200) cb(null, true);
//         else cb(new WiaExceptions.HTTPBadRequestError(response.statusCode, body || ''));
//       }
//     });
//   },
...
//           cb(null, true);
//         } else {
//           cb(new WiaExceptions.HTTPBadRequestError(response.statusCode, body || ''));
//         }
//       }
//     });
//   },
...
//       if (cb) {
//         if (error) return cb(error, null);
//         if (response.statusCode == 200 || response.statusCode == 201) cb(null, true);
//         else cb(new WiaExceptions.HTTPBadRequestError(response.statusCode, body || ''));
//       }
//     });
//   },
